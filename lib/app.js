...
var book1 = new _book2.default('YDKJS', 'Kyle Simpson');
var book2 = new _book2.default('JS The Good Parts', 'Douglas Crockford');
...
bookForm.addEventListener('submit', function (e) {
  ...
  books.push(new _book2.default(title, author));
